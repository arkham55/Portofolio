            ...
            >
              <div>
                <h4 className="text-xs font-bold uppercase tracking-wider text-primary flex items-center gap-2 mb-6 border-b border-white/5 pb-3">
                  ...
                  {t("Academic Profile", "Profil Akademik")}
                </h4>
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <span className="text-xs font-bold text-foreground">
                        {t(eduInfo.faculty, "Fakultas Teknik")}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <span className="text-xs font-bold text-foreground">
                        {t(eduInfo.major, "Teknologi Informasi")}
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <div className="mt-6 pt-4 border-t border-white/5 flex items-center justify-between">
                ...
                <Badge
                  variant="outline"
                  className="border-emerald-500/20 text-emerald-400 bg-emerald-500/5 text-[9px] rounded-full px-2.5"
                >
                  Dean&apos;s List
                </Badge>
              </div>
              ...
              <div className="space-y-3.5 text-xs">
                <div className="flex justify-between items-center pb-1">
                  ...
                  <span className="font-bold text-foreground">
                    {t(socialData.location, "Yogyakarta, Indonesia")}
                  </span>
                </div>
