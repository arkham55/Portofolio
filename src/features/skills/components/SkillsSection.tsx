...
const CATEGORIES: {
...
}[] = [
  {
    ...
    icon: Code2,
    glowClass: "hover:border-blue-500/30 hover:shadow-[0_10px_30px_rgba(59,130,246,0.1)]",
    pillClass: "border-blue-500/25 text-blue-300 bg-blue-500/5 hover:border-blue-400 hover:text-blue-200 hover:shadow-[0_0_10px_rgba(59,130,246,0.25)]",
  ...
  },
  {
    ...
    icon: Layers,
    glowClass: "hover:border-indigo-500/30 hover:shadow-[0_10px_30px_rgba(99,102,241,0.1)]",
    pillClass: "border-indigo-500/25 text-indigo-300 bg-indigo-500/5 hover:border-indigo-400 hover:text-indigo-200 hover:shadow-[0_0_10px_rgba(99,102,241,0.25)]",
  ...
  },
  {
    ...
    labelId: "Basis Data",
    icon: Database,
    glowClass: "hover:border-emerald-500/30 hover:shadow-[0_10px_30px_rgba(16,185,129,0.1)]",
    pillClass: "border-emerald-500/25 text-emerald-300 bg-emerald-500/5 hover:border-emerald-400 hover:text-emerald-200 hover:shadow-[0_0_10px_rgba(16,185,129,0.25)]",
  ...
  },
  {
    ...
    icon: Wrench,
    glowClass: "hover:border-rose-500/30 hover:shadow-[0_10px_30px_rgba(244,63,94,0.1)]",
    pillClass: "border-rose-500/25 text-rose-300 bg-rose-500/5 hover:border-rose-400 hover:text-rose-200 hover:shadow-[0_0_10px_rgba(244,63,94,0.25)]",
