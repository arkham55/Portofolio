...
export const projectsData: Project[] = [
  {
    ...
    subtitle: "Web-based yield estimation and farming prediction tool",
  ...
  },
  {
    ...
    subtitle: "Multi-laboratory inventory and activity logging platform",
    techStack: ["Laravel", "PHP", "MySQL", "Tailwind CSS"],
    overview:
  ...
  },
  {
    ...
    title: "EduBudget",
    subtitle:
      "Smart student budgeting and financial tracker with ML recommendations",
  ...
  },
  {
    ...
    demoUrl: "https://portofolio-arsya.vercel.app",
  },
];
...
export const projectsTranslationId: Record<string, Partial<Project>> = {
  "harvest-estimator": {
    ...
    overview:
      "Platform web interaktif yang dirancang untuk komunitas petani lokal untuk mengestimasi hasil panen, mengelola catatan pertanian, dan menghitung potensi pendapatan pertanian.",
    problem:
      "Petani dan koperasi desa kesulitan dengan perhitungan manual, metode estimasi tanaman yang tidak dapat diprediksi, dan kurangnya catatan digital untuk melacak tren panen musiman.",
    research:
      "Melakukan survei dengan kelompok tani lokal di Yogyakarta selama PLK UNY dan menemukan kebutuhan mendasar akan kalkulator tanaman yang mobile-friendly dan mudah dipahami.",
    solution:
      "Mengembangkan aplikasi Laravel responsif yang dilengkapi algoritma estimasi berat hasil panen, estimator pendapatan pertanian, dan catatan aktivitas pertanian dinamis.",
    architectureDescription:
      "Dibangun dengan arsitektur Laravel MVC. Menggunakan database MySQL untuk menyimpan data parameter pertanian, catatan tanaman musiman, dan menghasilkan laporan real-time melalui Blade views.",
    features: [
    ...
    challenges:
      "Merumuskan formula estimasi matematis yang akurat dengan mempertimbangkan indeks kualitas tanah dan variabel cuaca yang tidak menentu.",
    lessonsLearned:
      "Mendapatkan pengalaman praktis dalam membangun kalkulator algoritma kompleks di Laravel controller dan memetakan migrasi database untuk metrik pertanian dinamis.",
    futureImprovements:
      "Mengintegrasikan feed API prakiraan cuaca untuk menyesuaikan prediksi panen secara dinamis berdasarkan model curah hujan.",
  },
  "sistem-pendataan-lab": {
    subtitle:
      "Platform inventarisasi dan pencatatan aktivitas multi-laboratorium",
    overview:
      "Dashboard administratif khusus yang dibangun untuk mengelola dan mencatat operasional di berbagai laboratorium akademik di Universitas Negeri Yogyakarta, melacak inventaris dan pemanfaatan mahasiswa.",
    problem:
      "Mengelola log mahasiswa, penjadwalan reservasi, dan pelacakan status peralatan lab di berbagai laboratorium departemen secara manual menyebabkan kehilangan data dan konflik jadwal.",
    research:
      "Menganalisis buku log laboratorium fisik di UNY dan merancang model database terpadu yang mampu mengatur catatan lab secara indeks independen.",
    solution:
      "Membuat sistem manajemen berbasis web yang aman dengan audit inventaris otomatis, manajer jadwal, dan pencatatan aktivitas terpadu.",
    architectureDescription:
      "Terstruktur menggunakan Laravel MVC dengan tata letak perutean modular. File Blade menangani tampilan administratif, dan Vite mengelola proses kompilasi aset frontend.",
    features: [
    ...
    challenges:
      "Merancang skema database yang mendukung beberapa laboratorium independen sambil tetap mempertahankan kontrol administratif terpadu.",
    lessonsLearned:
      "Menguasai perancangan hubungan Eloquent dinamis dan menerapkan izin peran pengguna yang aman untuk asisten laboratorium dan kepala departemen.",
    futureImprovements:
      "Menerapkan dukungan pemindai barcode untuk pelacakan peralatan laboratorium dan audit aset yang lebih cepat.",
  },
  "sistem-kasir": {
    subtitle: "Sistem kasir (point of sale) dan inventaris untuk toko ritel",
    overview:
      "Aplikasi web kasir (POS) responsif yang dirancang untuk minimarket ritel untuk menangani transaksi checkout, melacak inventaris produk, dan memantau pendapatan penjualan harian.",
    problem:
      "Pemilik toko ritel menghadapi antrean checkout pelanggan yang lambat, kurangnya pembaruan inventaris secara real-time, dan proses audit penjualan manual.",
    research:
      "Menyelidiki operasional kasir toko dan membangun skema database yang dioptimalkan untuk pemrosesan transaksi cepat dan penghitungan stok dinamis.",
    solution:
      "Mengembangkan sistem kasir Laravel dengan pembuatan struk instan, izin peran untuk kasir dan manajer, serta audit inventaris otomatis yang memotong stok.",
    architectureDescription:
      "Dibangun pada arsitektur Laravel MVC. Menggunakan relasi Eloquent untuk memetakan item ke transaksi dan transaksi database untuk memastikan keamanan pembukuan.",
    features: [
    ...
    challenges:
      "Menangani transaksi penjualan bersamaan sambil memastikan tingkat stok berkurang secara akurat.",
    lessonsLearned:
      "Menerapkan mekanisme penguncian database di Laravel untuk menghindari konflik transaksi saat melakukan checkout produk.",
    futureImprovements:
      "Menambahkan integrasi pemindai barcode dan format struk cetak PDF otomatis.",
  },
  "sistem-rekomendasi-laptop": {
    subtitle: "Sistem rekomendasi laptop berbasis Python Flask",
    overview:
      "Aplikasi web interaktif yang dibangun menggunakan Python dan Flask yang merekomendasikan laptop berdasarkan preferensi pengguna dan spesifikasi teknis.",
    problem:
      "Pengguna menghadapi kesulitan dalam membaca spesifikasi laptop yang rumit (RAM, CPU, GPU) ketika mencoba membeli laptop sesuai budget tertentu.",
    research:
      "Mengumpulkan data spesifikasi laptop, membangun formula penilaian, dan merancang antarmuka yang ringan.",
    solution:
      "Mengembangkan aplikasi rekomendasi Flask yang memfilter dan menilai laptop sesuai spesifikasi dan budget pengguna.",
    architectureDescription:
      "Backend Python Flask dengan pemrosesan data dasar dalam modul pembantu. Template menyajikan UI HTML/CSS dengan JavaScript di sisi klien.",
    features: [
    ...
    challenges:
      "Menormalisasi nama benchmark GPU dan CPU serta menangani data yang hilang.",
    lessonsLearned:
      "Mendapatkan pengalaman mendalam dalam membangun rute backend python, merender template di Flask, dan pemrosesan data dasar.",
    futureImprovements:
      "Mengintegrasikan model pengelompokan machine learning (KNN) untuk rekomendasi semantik tingkat lanjut.",
  },
  edubadget: {
    subtitle: "Pelacak keuangan mahasiswa cerdas dengan rekomendasi ML",
    overview:
      "Aplikasi keuangan pribadi inovatif yang dibangun untuk mahasiswa untuk melacak pengeluaran, mencatat pemasukan, dan menerima prediksi tabungan yang dipersonalisasi berdasarkan kebiasaan gaya hidup.",
    problem:
      "Mahasiswa sering kali kesulitan dengan budget yang terbatas, menyebabkan pengeluaran tidak terencana, kurangnya struktur tabungan, dan tidak adanya saran keuangan yang disesuaikan dengan pemasukan.",
    research:
      "Membangun survei gaya hidup kustom (hemat, moderat, aktif) untuk melatih model regresi dinamis yang memetakan panduan anggaran ke kebiasaan pengeluaran mahasiswa.",
    solution:
      "Mengembangkan portal web Flask yang mengintegrasikan dashboard real-time, log transaksi, dan perencana anggaran interaktif dengan peringatan berbasis ML untuk pengeluaran berlebihan.",
    architectureDescription:
      "Backend Python Flask dengan penangan database modular. Folder ML menampung model regresi, template merender UI, dan MySQL mengelola akun pengguna dan riwayat transaksi.",
    features: [
    ...
    challenges:
      "Merumuskan logika prediksi machine learning yang akurat yang memperhitungkan uang saku bulanan mahasiswa yang sangat tidak menentu.",
    lessonsLearned:
